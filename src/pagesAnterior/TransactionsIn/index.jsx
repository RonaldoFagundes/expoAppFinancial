...
export default function TransactionsIn({ navigation }) {
   ...
   const safePost = async () => {
      ...
      await fetch(endpointPhp + "?action=postTransactionIn", {
          method: 'POST',
          headers: {
          ...
          .then(
              (result) => {
                  ...
                  console.log(' postTransactionIn => ' + result);
   ...
   <View style={styles.main}>
     ...
     <View style={styles.containerHeader}>         
         ...
         <View>
            ...
            <Text style={styles.textList}>Tela TransactionsIn - Account Info</Text>
